...
<div class="max-w-2xl mx-auto bg-white p-8 shadow">
    <h2 class="text-2xl font-bold mb-6">Cadastrar Produto</h2>
    ...
    <form method="POST" action="{{ route('admin.produtos.store') }}" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="cnpj_cpf" value="{{ old('cnpj_cpf', $cnpjCpfEmpresa) }}" class="cnpj-cpf-mask w-full border rounded px-2 py-1 @error('cnpj_cpf') border-red-500 @enderror" maxlength="18" inputmode="numeric" required />
        ...
        <div>
            ...
            <div class="mt-1 flex items-stretch gap-2 md:max-w-xl">
                <input type="text" id="produtoImagemInput" name="IMG" value="{{ old('IMG') }}" class="w-full border rounded px-2 py-1" placeholder="https://... ou /storage/..." />
                <a
...
@php($__previewPx = (int) ($produtoFormImagePreviewSize ?? 48))
        ...
        <div class="flex space-x-2 pt-4">
            <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded">Cadastrar</button>
