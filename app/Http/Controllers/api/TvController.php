    ...
    public function webScreenConfig(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'offerSlideDescriptionOffsetY' => (int) ($config->offerSlideDescriptionOffsetY ?? 0),
                'offerSlideDescriptionOffsetX' => (int) ($config->offerSlideDescriptionOffsetX ?? 0),
                'offerSlideDescriptionBorderEnabled' => (bool) ($config->offerSlideDescriptionBorderEnabled ?? true),
                'offerSlideDescriptionBorderColor' => (string) ($config->offerSlideDescriptionBorderColor ?? '#94a3b8'),
                'offerSlideDescriptionBorderWidth' => (int) ($config->offerSlideDescriptionBorderWidth ?? 1),
                'offerSlideBackgroundColorStart' => (string) ($config->offerSlideBackgroundColorStart ?? '#0F172A'),
                'offerSlideBackgroundColorEnd' => (string) ($config->offerSlideBackgroundColorEnd ?? '#020617'),
                'offerSlideBackgroundTransparent' => (bool) ($config->offerSlideBackgroundTransparent ?? false),
                'offerSlideBackgroundImageUrl' => (string) ($config->offerSlideBackgroundImageUrl ?? ''),
                'offerSlideBackgroundImageFullScreen' => (bool) ($config->offerSlideBackgroundImageFullScreen ?? true),
                'offerSlideBackgroundImageWidth' => (int) ($config->offerSlideBackgroundImageWidth ?? 0),
                'offerSlideBackgroundImageHeight' => (int) ($config->offerSlideBackgroundImageHeight ?? 0),
                'offerSlideBackgroundImageMarginTop' => (int) ($config->offerSlideBackgroundImageMarginTop ?? 0),
                'offerSlideBackgroundImageMarginBottom' => (int) ($config->offerSlideBackgroundImageMarginBottom ?? 0),
                'offerSlideSingleItemProductImageEnabled' => (bool) ($config->offerSlideSingleItemProductImageEnabled ?? true),
                'offerSlideSingleItemProductImageWidth' => (int) ($config->offerSlideSingleItemProductImageWidth ?? 320),
                'offerSlideSingleItemProductImageHeight' => (int) ($config->offerSlideSingleItemProductImageHeight ?? 320),
                'offerSlideSingleItemProductImageTop' => (int) ($config->offerSlideSingleItemProductImageTop ?? 32),
                'offerSlideSingleItemProductImageRight' => (int) ($config->offerSlideSingleItemProductImageRight ?? 3),
                'offerSlideSingleItemProductImageSide' => (string) ($config->offerSlideSingleItemProductImageSide ?? 'right'),
                'offerSlideSingleItemProductImageVerticalPosition' => (string) ($config->offerSlideSingleItemProductImageVerticalPosition ?? 'top'),
                'offerSlideSingleItemProductImageBorderEnabled' => (bool) ($config->offerSlideSingleItemProductImageBorderEnabled ?? true),
                'offerSlideSingleItemProductImageBorderColor' => (string) ($config->offerSlideSingleItemProductImageBorderColor ?? '#ffffff1a'),
                'offerSlideSingleItemProductImageBorderWidth' => (int) ($config->offerSlideSingleItemProductImageBorderWidth ?? 1),
                'offerSlideTitleEnabled' => (bool) ($config->offerSlideTitleEnabled ?? true),
                'offerSlideTitleText' => (string) ($config->offerSlideTitleText ?? 'Slide de oferta'),
                'offerSlideTitleColor' => (string) ($config->offerSlideTitleColor ?? '#FDE68A'),
                'offerSlideTitleFontSize' => (int) ($config->offerSlideTitleFontSize ?? 48),
                'offerSlideTitleFontFamily' => (string) ($config->offerSlideTitleFontFamily ?? 'arial'),
                'offerSlideTitleAlignment' => (string) ($config->offerSlideTitleAlignment ?? 'left'),
                'offerSlideLayoutMode' => (string) ($config->offerSlideLayoutMode ?? 'double_list'),
                ...
                'offerSlideCardBorderColor' => (string) ($config->offerSlideCardBorderColor ?? '#94a3b8'),
                'offerSlideCardBorderWidth' => (int) ($config->offerSlideCardBorderWidth ?? 1),
                'offerSlideScreenBorderEnabled' => (bool) ($config->offerSlideScreenBorderEnabled ?? true),
                'offerSlideScreenBorderColor' => (string) ($config->offerSlideScreenBorderColor ?? '#94a3b8'),
                'offerSlideScreenBorderWidth' => (int) ($config->offerSlideScreenBorderWidth ?? 1),
                ...
                'offerSlidePriceAlignment' => (string) ($config->offerSlidePriceAlignment ?? 'left'),
                'offerSlidePriceOffsetY' => (int) ($config->offerSlidePriceOffsetY ?? 0),
                'offerSlidePriceOffsetX' => (int) ($config->offerSlidePriceOffsetX ?? 0),
                'offerSlidePriceBorderEnabled' => (bool) ($config->offerSlidePriceBorderEnabled ?? true),
                'offerSlidePriceBorderColor' => (string) ($config->offerSlidePriceBorderColor ?? '#94a3b8'),
                'offerSlidePriceBorderWidth' => (int) ($config->offerSlidePriceBorderWidth ?? 1),
